...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    private static final String BOOK_NOT_FOUND_EXCEPTION = "There is no book by id: ";
    private static final String USER_NOT_FOUND_EXCEPTION = "There is no user by id: ";
    private static final String SHOPPING_CART_NOT_FOUND_EXCEPTION = "There is no cart by user id: ";
    private static final String CART_ITEM_NOT_FOUND_EXCEPTION = "There is no cart by id: ";
        ...
        Book book = bookRepository.findById(bookId)
                .orElseThrow(
                        () -> new EntityNotFoundException(
                                BOOK_NOT_FOUND_EXCEPTION + bookId
                        ));
    ...
    public ShoppingCartDto updateByCartItemId(
        ...
        CartItem cartItem = cartItemRepository.findById(cartItemId)
                .orElseThrow(() -> new EntityNotFoundException(
                        CART_ITEM_NOT_FOUND_EXCEPTION + cartItemId
                ));
        cartItem.setQuantity(requestDto.getQuantity());
